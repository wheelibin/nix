...
let
  qrypad = pkgs.stdenvNoCC.mkDerivation {
    ...
    src = pkgs.fetchurl {
      url = "https://github.com/wheelibin/qrypad/releases/download/v1.6.0/qrypad_1.6.0_darwin_arm64.tar.gz";
      hash = "sha256-5DG9rhdHGJRswC0EwS/K1wdYFgNxr0YiYbhMmynABKY=";
    };
